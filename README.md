...
**Reviewing one of my past projects** is a project with the following objectives;
...
Clone this repository to your desired folder:
  cd my-folder
  git clone https://github.com/mumo-esther/self-code-review.git
...
This project is [MIT](https://github.com/mumo-esther/self-code-review/blob/main/LICENSE) licensed.
